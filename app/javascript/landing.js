(function() {
    ...
    var view = {
        ...
        showUnapplicableDialog: function() {
            ...
            isIPhone && ( param.textContent = '亲，iOS7.0以上才能使用哦！' );
            isAndroid && ( param.textContent = '亲，Android4.0以上才能使用哦！' );
        ...
        showMask: function() {
            ...
            ( isAndroid ) && ( mask.style.opacity = '0.8' ); 
            ( !isAndroid ) && ( Run() ) ; 
        },
        hideMask: function() {
            var t = 0.8,
            ...
            ( isAndroid ) && ( mask.style.opacity = '0' ); 
            ( !isAndroid ) && ( Run() ) ;
        }
    }
    ...
    var evt = {
        ...
        init: function() {
            ...
            // click div不调用； touchstart会提示无效url， touchend会误按； a标签click的时候background-image没了；
            this.delegate(document.body, 'click', 'x-url-zhuoji', function(e, target) {
                e.preventDefault();
                e.stopPropagation();
    ...
    var cidEle = document.getElementById('cid');
    var topage = cidEle ? 'z/zj/conv?cid=' + cidEle.value : '';

    //////////////////////////////////////////
    /// url的管理, 参数处理，管理页面跳转url
    //////////////////////////////////////////
    var router = {
        android: 'zhuoji://' + topage,
        iphone: 'zhuoji://' + topage,
